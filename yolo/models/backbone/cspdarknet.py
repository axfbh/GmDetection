...
from yolo.models.neck.spp import SPPF
...
def cpsdarknetv4s(pretrained, norm_layer):
    base_depth = max(round(0.33 * 3), 1)  # 3
    base_channels = int(0.50 * 32)  # 64

    return CSPDarknetV4(base_channels, base_depth)


def cpsdarknetv4m(pretrained, norm_layer):
    base_depth = max(round(0.67 * 3), 1)  # 3
    base_channels = int(0.75 * 32)  # 64

    return CSPDarknetV4(base_channels, base_depth)


def cpsdarknetv4l(pretrained, norm_layer):
    base_depth = max(round(1.0 * 3), 1)  # 3
    base_channels = int(1.0 * 32)  # 64
...
def cpsdarknetv4x(pretrained, norm_layer):
    base_depth = max(round(1.0 * 3), 1)  # 3
    base_channels = int(1.25 * 32)  # 64

    return CSPDarknetV4(base_channels, base_depth)


# --------------- v5 backbone ---------------
def cpsdarknetv5n(pretrained, norm_layer):
    base_depth = max(round(0.33 * 3), 1)  # 3
    base_channels = int(0.25 * 64)  # 64

    return CSPDarknetV5(base_channels, base_depth)


def cpsdarknetv5s(pretrained, norm_layer):
    base_depth = max(round(0.33 * 3), 1)  # 3
    base_channels = int(0.50 * 64)  # 64

    return CSPDarknetV5(base_channels, base_depth)


def cpsdarknetv5m(pretrained, norm_layer):
    base_depth = max(round(0.67 * 3), 1)  # 3
    base_channels = int(0.75 * 64)  # 64

    return CSPDarknetV5(base_channels, base_depth)


def cpsdarknetv5l(pretrained, norm_layer):
    base_depth = max(round(1.0 * 3), 1)  # 3
...
def cpsdarknetv5x(pretrained, norm_layer):
    base_depth = max(round(1 * 3), 1)  # 3
    base_channels = int(1.25 * 64)  # 64
