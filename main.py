...
if __name__ == '__main__':
    ...
    model = YOLO("./runs/detect/train/version_1/checkpoints/last.pt", task='detect')
    model.train(data="./cfg/datasets/coco.yaml", resume=True, device='0', imgsz=640, epochs=100, batch=8, box=7.5,
                cls=0.5, dfl=1.5)
